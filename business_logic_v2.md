...
- Если на матч уже 14 заявок в статусе Reviewed/Registered/Confirmed → автоматический переход в **Waitlisted**
...
**Условия:**
- Заявка может быть одобрена только если есть свободные места (< 14 игроков в статусах Reviewed/Registered/Confirmed)
