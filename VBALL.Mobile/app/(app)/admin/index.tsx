    ...
    <>
        ...
        <View style={styles.section}>
          ...
          {participants.length === 0 ? (
            ...
            participants.map((participant) => {
              const badgeTone =
                participationStatusBadge[participant.status];
              return (
                <View
      ...
      >
        <View style={styles.formModalOverlay}>
          <View style={[styles.formModal, { paddingBottom: insets.bottom + 24 }]}>
            ...
            >
              ...
              <Text style={styles.formValue}>
                {formState.teamAId
                  ? teams[Number(formState.teamAId)]?.name ?? `Team ${formState.teamAId}`
                  : 'Выберите команду'}
              </Text>
            </Pressable>
            ...
            >
              ...
              <Text style={styles.formValue}>
                {formState.teamBId
                  ? teams[Number(formState.teamBId)]?.name ?? `Team ${formState.teamBId}`
                  : 'Выберите команду'}
              </Text>
            </Pressable>
...
const styles = StyleSheet.create({
  ...
  badgeWarning: {
    backgroundColor: VBALL_COLORS.warningBg,
  },
  badgeDanger: {
    backgroundColor: VBALL_COLORS.dangerBg,
  },
